...
import LimbExtensionQuantifierMetric, {
	type LimbExtensionQuantifierOptions
} from './LimbExtensionQuantifierMetric';

export type HandExtensionExtremaQuantifierOptions = Omit<
	LimbExtensionQuantifierOptions,
	'includedLimbs'
> & {
