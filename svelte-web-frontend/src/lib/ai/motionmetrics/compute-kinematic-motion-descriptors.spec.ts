...
import type { Pose2DPixelLandmarks, PixelLandmark, Pose3DLandmarkFrame } from '$lib/webcam/mediapipe-utils.js';
...
describe('calculateKinematicErrorDescriptors', () => {
  ...
  it('should throw error with invalid landmark weights', () => {
    ...
    expect(() => calculateKinematicErrorDescriptors(mockKinematicValues, {
