...
def update_create_entry(
    ...
    out_entry['clipRelativeStem'] = (Path(clip_path).parent / Path(clip_path).stem).as_posix()
...
if __name__ == "__main__":
    ...
    parser.add_argument('--database_path', type=Path, help='Path to the database.json file')
